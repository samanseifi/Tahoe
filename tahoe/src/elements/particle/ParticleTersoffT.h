/* $Id: ParticleTersoffT.h,v 1.2 2006/07/25 16:29:47 d-farrell2 Exp $ */
...
class TersoffPropertyT;
class StringT;

/** base class for particle types */
class ParticleTersoffT: public ParticleT
{
public:

	/** constructor */
	ParticleTersoffT(const ElementSupportT& support);
...
protected:
	...
	enum ParticleTersoffOutputCodeT {
		kDisplacement = 0,
		kPE = 1,
		kKE = 2,
		kStress = 3,
...
private:
	...
	ArrayT<TersoffPropertyT*> fTersoffProperties;
