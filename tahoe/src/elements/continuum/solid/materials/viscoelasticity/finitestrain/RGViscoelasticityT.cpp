...
void  RGViscoelasticityT::PointInitialize(void)
{
...
void RGViscoelasticityT::UpdateHistory(void)
{
	/* current element */
	ElementCardT& element = CurrentElement();	
...
void RGViscoelasticityT::ResetHistory(void)
{
	/* current element */
	ElementCardT& element = CurrentElement();	
	for (int ip = 0; ip < NumIP() && fNumProcess > 0; ip++)
...
GlobalT::SystemTypeT RGViscoelasticityT::TangentType(void) const
{
...
void RGViscoelasticityT::Store(ElementCardT& element, int ip)
{
	/* fetch internal variable array */
	dArrayT& d_array = element.DoubleData();
...
void RGViscoelasticityT::MixedRank4_2D(const dArrayT& a, const dArrayT& b, 
...
void RGViscoelasticityT::MixedRank4_3D(const dArrayT& a, const dArrayT& b, 
	dMatrixT& rank4_ab) const
{
#if __option(extended_errorcheck)
	if (a.Length() != 3 ||
