/* $Id: SolidElementT.cpp,v 1.87 2012/08/13 19:29:54 hspark Exp (minor edition by samansei 2015/06/07) $ */
	...
	const iArrayT& e_codes, ArrayT<StringT>& e_labels) const
{
  ...
  if (n_codes[ND_ELEC_FLD]) {
	...
	const char* labels1D[] = {"E1", "EMag"};
	const char* labels2D[] = {"E1", "E2", "EMag"};
	const char* labels3D[] = {"E1", "E2", "E3", "EMag"};
