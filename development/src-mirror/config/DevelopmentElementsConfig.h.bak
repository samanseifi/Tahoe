...
/* created: Wed Jul 19 23:55:19 EDT 2017 */
...
/** \def DIELECTRIC_ELASTOMER_Q1P02D_MECHANICAL
 * 2D Dielectric Elastomer with (hopefully) locking-free Q1P0 formulation.
 * This option must be set in conjunction with the DIRECTORY_DIELECTRIC_ELASTOMER_Q1P02D_MECHANICAL macro
 * in DevelopmentElementsConfig.make. */
#define DIELECTRIC_ELASTOMER_Q1P02D_MECHANICAL 1
