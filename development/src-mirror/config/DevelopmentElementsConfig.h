...
/* created: Mon May  1 14:13:27 EDT 2017 */
...
/** \def DIELECTRIC_ELASTOMER_Q1P02D_Structural
 * Step 1 (Structural): Staggered procedure of 2D dielectric elastomer with (hopefully) locking-free Q1P0 formulation.
 * This option must be set in conjunction with the DIRECTORY_DIELECTRIC_ELASTOMER_Q1P02D_Structural macro
 * in DevelopmentElementsConfig.make. */
/* #define DIELECTRIC_ELASTOMER_Q1P02D_Structural 1 */

/** \def DIELECTRIC_ELASTOMER_Q1P02D_Electrical
 * Step 2 (Electrical): Staggered procedure of 2D dielectric elastomer with (hopefully) locking-free Q1P0 formulation.
 * This option must be set in conjunction with the DIRECTORY_DIELECTRIC_ELASTOMER_Q1P02D_Electrical macro
 * in DevelopmentElementsConfig.make. */
/* #define DIELECTRIC_ELASTOMER_Q1P02D_Electrical 1 */
