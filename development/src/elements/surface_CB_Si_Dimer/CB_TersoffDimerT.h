/* $Id: CB_TersoffDimerT.h,v 1.1 2007/11/09 16:53:55 hspark Exp $ */
/* created: paklein (10/14/1998) */
#ifndef _CB_TERSOFFDIMER_T_H_
#define _CB_TERSOFFDIMER_T_H_
...
class TersoffDimerSolverT;

class CB_TersoffDimerT: public NL_E_MatT
{
public:

	/** constructor */
	CB_TersoffDimerT(void);

	/* destructor */
	virtual ~CB_TersoffDimerT(void);
...
private:
	...
	/** TersoffDimer solver */
	TersoffDimerSolverT* fTersoffDimerSolver;
