...
#if !defined(_FSDielectricElastomerQ1P0ViscoT_)
#define _FSDielectricElastomerQ1P0ViscoT_
...
namespace Tahoe {
  ...
  class FSDEMatSupportQ1P0ViscoT;

  // interface for finite deformation dielectric elastomers 
  // based on 2008 JMPS paper of Suo et al.
  
  class FSDielectricElastomerQ1P0ViscoT: public FiniteStrainT {

  public:

    // constructor
    FSDielectricElastomerQ1P0ViscoT(const ElementSupportT& support);

    // destructor
    virtual ~FSDielectricElastomerQ1P0ViscoT();
  ...
  protected:
    ...
    // FSDielectricElastomerQ1P0ViscoT::NewMaterialList is called.
    FSDEMatSupportQ1P0ViscoT* fFSDEMatSupportQ1P0Visco;
  ...
  private:
    ...
    FSDEMatQ1P0ViscoT* fCurrMaterial;
...
#endif // _FSDielectricElastomerQ1P0ViscoT_
