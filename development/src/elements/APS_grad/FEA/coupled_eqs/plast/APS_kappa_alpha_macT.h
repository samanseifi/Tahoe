...
/** APS_kappa_alpha_macT: This class contains methods which build stiffness matricies 
 ...
 *  AND treat stress difference in slip rate evolution as Macauley bracket
 **/


class APS_kappa_alpha_macT : public PlastT
{
	...
	//--------------------------------------------------------------
 	...
 	APS_kappa_alpha_macT	( void ) { }
								
	APS_kappa_alpha_macT	( FEA_ShapeFunctionT&, FEA_ShapeFunctionT&, APS_MaterialT*, APS_VariableT&, APS_VariableT&, 
...
#endif /* _APS_KAPPA_ALPHA_MAC_T_H_ */
