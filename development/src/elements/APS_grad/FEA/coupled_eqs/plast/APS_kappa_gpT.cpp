...
APS_kappa_gpT::APS_kappa_gpT	(FEA_ShapeFunctionT &Shapes_displ, FEA_ShapeFunctionT &Shapes_plast, APS_MaterialT *APS_Matl, 
						APS_VariableT &np1, 
...
void APS_kappa_gpT::Initialize (int &in_ip, int &in_sd, int &in_en_displ, int &in_en_plast, int &in_state, int &in_str, 
...
void APS_kappa_gpT::Construct (FEA_ShapeFunctionT &Shapes_displ, FEA_ShapeFunctionT &Shapes_plast, APS_MaterialT *APS_Matl, 
...
void APS_kappa_gpT::Form_LHS_Keps_Kd ( dMatrixT &Keps, dMatrixT &Kd )
{
...
void APS_kappa_gpT::Form_RHS_F_int ( dArrayT &F_int ) 
{
...
void APS_kappa_gpT::Form_C_List (APS_MaterialT *APS_Matl)
{
...
void APS_kappa_gpT::Form_V_S_Lists (  APS_VariableT &npt, APS_VariableT &n )
{
	...
	#pragma message("APS_kappa_gpT::Form_V_S_Lists: are these grads what I think they are? ")
...
void APS_kappa_gpT::Form_VB_List (void)
{					
...
void APS_kappa_gpT::Form_B_List (void)
{
...
void APS_kappa_gpT::Get ( StringT &Name, FEA_dMatrixT &tensor )
{
	if ( Name == "grad_u" )
		...
		cout << " ...ERROR: APS_kappa_gpT::Get() >> Unknown tensor '"<<Name<<"' requested. \n";
}

//##############################################################################################

void APS_kappa_gpT::Get ( StringT &Name, FEA_dVectorT &vector )
{
	if ( Name == "gammap" )
		vector = V[kgammap];
	else if ( Name == "out" )
		...
		cout << " ...ERROR: APS_kappa_gpT::Get() >> Unknown vector '"<<Name<<"' requested. \n";
}

//##################################################################################

void APS_kappa_gpT::Get ( StringT &Name, FEA_dScalarT &scalar )
{
	if ( Name == "kappa" )
		scalar = S[kIV_kappa1];
	else
		cout << " ...ERROR: APS_kappa_gpT::Get() >> Unknown scalar '"<<Name<<"' requested. \n";
}
