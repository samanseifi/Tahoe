// $Id: APS_FEA_Data_Processor_PlastT.h,v 1.1 2004/02/17 19:48:49 raregue Exp $
#ifndef _APS_FEA_DATAPROCESSOR_PLASTT_H_
#define _APS_FEA_DATAPROCESSOR_PLASTT_H_

#include "FEA.h"

namespace Tahoe {

class APS_FEA_Data_Processor_PlastT  
{
	public:
		...
		enum NumberT { k1, k2, k3, k4, k5, k6, k7, k8, k9, k10 }; // <-- numbers are one less than face value
		 ...
		 APS_FEA_Data_Processor_PlastT 	(); 
		~APS_FEA_Data_Processor_PlastT 	(); 
		APS_FEA_Data_Processor_PlastT 	( FEA_dMatrixT &fdNdx  );
