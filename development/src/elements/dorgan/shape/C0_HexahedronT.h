/* $Id: C0_HexahedronT.h,v 1.1 2004/09/02 18:25:08 rdorgan Exp $ */ 
#ifndef _C0_HEXAHEDRON_T_H_
#define _C0_HEXAHEDRON_T_H_
...
class C0_HexahedronT: public ShapeTools, public GeometryT
{
 public:
	/** constructor */
	C0_HexahedronT(GeometryT::CodeT geometry_code, int numip, int numnd_u, int numdof_u, const LocalArrayT& coords);
 ...
 private: 
	/** compute local shape functions and derivatives at IPs for 3D. 
