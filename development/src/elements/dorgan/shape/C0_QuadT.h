/* $Id: C0_QuadT.h,v 1.1 2004/09/02 18:25:08 rdorgan Exp $ */ 
...
class C0_QuadT: public ShapeTools, public GeometryT
{
 public:
	/** constructor */
	C0_QuadT(GeometryT::CodeT geometry_code, int numip, int numnd_u, int numdof_u, const LocalArrayT& coords);
