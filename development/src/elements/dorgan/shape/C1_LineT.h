/* $Id: C1_LineT.h,v 1.1 2004/09/02 18:25:08 rdorgan Exp $ */ 
...
class C1_LineT: public ShapeTools, public GeometryT
{
 public:
	/** constructor */
	C1_LineT(GeometryT::CodeT geometry_code, int numip, int numnd_u, int numdof_u, const LocalArrayT& coords);
