/* $Id: C0_LineT.h,v 1.1 2004/09/02 18:25:08 rdorgan Exp $ */ 
#ifndef _C0_LINE_T_H_
#define _C0_LINE_T_H_
...
class C0_LineT: public ShapeTools, public GeometryT
{
 public:
	/** constructor */
	C0_LineT(GeometryT::CodeT geometry_code, int numip, int numnd_u, int numdof_u, const LocalArrayT& coords);
