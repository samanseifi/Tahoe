/* $Id: SMP_multi.h,v 1.1 2010/12/06 20:17:42 thao Exp $ */
...
class SMP_multi: public RGSplitT2
{
   public:
   ...
   private:
	...
	double StructuralRelaxationFunc(const double Temperature, const double deltaneq);
	/*returns  tau_S/tauS0, normalized stress relaxation time*/
	double StressRelaxationFunc(const double Temperature, const double deltaneq, const double smag, const double sy);	
	/*returns  tau_Y/tauY0, normalized  relaxation time for evolution of yield strength*/
	double YieldRelaxationFunc(const double Temperature, const double deltaneq, const double smag, const double sy);	
