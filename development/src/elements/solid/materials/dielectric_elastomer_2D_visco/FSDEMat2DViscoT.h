...
#if !defined(_FSDEMat2DViscoT_)
#define _FSDEMat2DViscoT_
...
namespace Tahoe {
  ...
  class FSDEMat2DViscoT: public FSSolidMatT
  {
  ...
  public:
    ...
    void SetFSDEMatSupport2DVisco(const FSDEMatSupport2DViscoT* support);
...
//	virtual const dMatrixT& ThermalDeformation_Inverse(void);
  ...
  protected:
    ...
    const FSDEMatSupport2DViscoT* fFSDEMatSupport2DVisco;
...
//#include "FSDEMat2DViscoT.i.h"

#endif // _FSDEMat2DViscoT_
