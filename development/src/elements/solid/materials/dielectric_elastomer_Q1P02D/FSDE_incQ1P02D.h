#ifndef FSDE_INCQ1P02D_H
#define FSDE_INCQ1P02D_H
...
void me_mixedmodulus_q1p02D(const double* params, const double *Xsi, const double* Cmat, const double* Fmat, double J, double* dCdXsi);

/* push forward electromechanical modulus to current configuration */
void me_mixedmodulus_q1p02Dspatial(const double* params, const double *Xsi, const double* Cmat, const double* Fmat, double J, double* Kempf);
...
void me_tanmod_q1p02D(const double* params, const double* Xsi, const double* Cmat, const double* Fmat, double J, double* ddCmechelec);
