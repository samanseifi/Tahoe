...
namespace Tahoe {
  ...
  FSDielectricElastomerQ1P02DMechanicalT::FSDielectricElastomerQ1P02DMechanicalT(
  ...
  {
    SetName("dielectric_elastomer_Q1P02DMechanical");
  }
...
/* Destructor */
  ...
  void FSDielectricElastomerQ1P02DMechanicalT::DefineParameters(ParameterListT& list) const
  {
    // inherited
...
//	list.RemoveParameter("store_shapefunctions");
  ...
  void FSDielectricElastomerQ1P02DMechanicalT::TakeParameterList(const ParameterListT& list)
  {
    // inherited
    ...
    if (!fElectricScalarPotentialField) {
      ExceptionT::GeneralFail("FSDielectricElastomerQ1P02DMechanicalT::TakeParameterList",
	...
	/* Q1P0 STUFF */
	const char caller[] = "FSDielectricElastomerQ1P02DMechanicalT::TakeParameterList";
...
GlobalT::SystemTypeT FSDielectricElastomerQ1P02DMechanicalT::TangentType(void) const
{
	/* Define LHS type based upon analysis type, i.e. static vs. dynamic */
 	int order = fIntegrator->Order();
 	if (order == 2)
...
void FSDielectricElastomerQ1P02DMechanicalT::CloseStep(void)
{
	/* inherited */
...
GlobalT::RelaxCodeT FSDielectricElastomerQ1P02DMechanicalT::ResetStep(void)
{
	/* inherited */
...
void FSDielectricElastomerQ1P02DMechanicalT::ReadRestart(istream& in)
{
	/* inherited */
...
void FSDielectricElastomerQ1P02DMechanicalT::WriteRestart(ostream& out) const
{
	/* inherited */
  ...
  MaterialSupportT*
  FSDielectricElastomerQ1P02DMechanicalT::NewMaterialSupport(MaterialSupportT* p) const
  {
    // allocate
  ...
  MaterialListT*
  FSDielectricElastomerQ1P02DMechanicalT::NewMaterialList(const StringT& name, int size)
  {
    ...
    if (size > 0) {
        ...
        if (0 == fFSDEMatSupportQ1P02D) {
          ExceptionT::GeneralFail("FSDielectricElastomerQ1P02DMechanicalT::NewMaterialList");
        }
      }
...
void FSDielectricElastomerQ1P02DMechanicalT::SetShape(void)
{
	/* inherited */
  ...
  void FSDielectricElastomerQ1P02DMechanicalT::SetGlobalShape()
  {
    // inherited
    FiniteStrainT::SetGlobalShape();
  ...
  void FSDielectricElastomerQ1P02DMechanicalT::CurrElementInfo(ostream& out) const
  {
    // inherited
...
//  increment current element - for ComputeOutput
  bool FSDielectricElastomerQ1P02DMechanicalT::NextElement()
  {
  ...
  void FSDielectricElastomerQ1P02DMechanicalT::SetLocalArrays()
  {
    ...
    if (0 == esp) {
      ...
      std::cout << std::endl;
      std::cout << "FSDielectricElastomerQ1P02DMechanicalT::SetLocalArrays: ";
  ...
  //
  void FSDielectricElastomerQ1P02DMechanicalT::Equations(AutoArrayT<const iArray2DT*>& eq_1,
  ...
  //
  int FSDielectricElastomerQ1P02DMechanicalT::TotalNumDOF() const
  {
 	int mechdof = 2;
 	int elecdof = 1;
  ...
  const dArrayT&
  FSDielectricElastomerQ1P02DMechanicalT::ElectricField() const
  {
  ...
  //
  const dArrayT&
  FSDielectricElastomerQ1P02DMechanicalT::ElectricField(int ip) const
  {
    return fE_List[ip];
  }

/* accumulate the residual force on the specified node */
void FSDielectricElastomerQ1P02DMechanicalT::AddNodalForce(const FieldT& field, int node, dArrayT& force)
{
	/* not my field */
//	if (&field != &(Field())) return;
 ...
 // void FSDielectricElastomerQ1P02DMechanicalT::Set_G(const dArray2DT& DNaX, dMatrixT& G)
 // {

 // }
/* calculate the LHS of residual, or element stiffness matrix */
  void FSDielectricElastomerQ1P02DMechanicalT::FormStiffness(double constK)
  {
...
/* Compute RHS, or residual of element equations */
  void FSDielectricElastomerQ1P02DMechanicalT::FormKd(double constK)
  {
...
void FSDielectricElastomerQ1P02DMechanicalT::FormMass(MassTypeT mass_type, double constM, bool axisymmetric, const double* ip_weight)
{
...
void FSDielectricElastomerQ1P02DMechanicalT::FormMa(MassTypeT mass_type, double constM, bool axisymmetric,
	const LocalArrayT* nodal_values, const dArray2DT* ip_values, const double* ip_weight)
{
	const char caller[] = "FSDielectricElastomerQ1P02DMechanicalT::FormMa";
...
void FSDielectricElastomerQ1P02DMechanicalT::MassMatrix()
{
...
void FSDielectricElastomerQ1P02DMechanicalT::SetMeanGradient(dArray2DT& mean_gradient, double& H, double& v) const
{
...
void FSDielectricElastomerQ1P02DMechanicalT::bSp_bRq_to_KSqRp(const dMatrixT& b, dMatrixT& K) const
{
  ...
  void FSDielectricElastomerQ1P02DMechanicalT::ComputeOutput(const iArrayT& n_codes,
