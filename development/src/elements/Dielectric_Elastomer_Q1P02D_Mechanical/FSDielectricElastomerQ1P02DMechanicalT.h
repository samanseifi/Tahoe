...
#if !defined(_FSDielectricElastomerQ1P02DMechanicalT_)
#define _FSDielectricElastomerQ1P02DMechanicalT_
...
namespace Tahoe {
  ...
  class FSDielectricElastomerQ1P02DMechanicalT: public FiniteStrainT {

  public:

    // constructor
    FSDielectricElastomerQ1P02DMechanicalT(const ElementSupportT& support);

    // destructor
    virtual ~FSDielectricElastomerQ1P02DMechanicalT();
  ...
  protected:
    ...
    // FSDielectricElastomerQ1P02DMechanicalT::NewMaterialList is called.
...
#endif // _FSDielectricElastomerQ1P02DMechanicalT_
