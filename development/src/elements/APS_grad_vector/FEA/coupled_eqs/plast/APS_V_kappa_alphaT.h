// $Id: APS_V_kappa_alphaT.h,v 1.1 2004/03/02 23:46:50 raregue Exp $
#ifndef _APS_V_KAPPA_ALPHA_T_H_ 
#define _APS_V_KAPPA_ALPHA_T_H_ 

#include "V_PlastT.h"

namespace Tahoe {

/** APS_V_kappa_alphaT: This class contains methods which build stiffness matricies 
...
class APS_V_kappa_alphaT : public V_PlastT
{
	...
	//--------------------------------------------------------------
 	...
 	APS_V_kappa_alphaT	( void ) { }
								
	APS_V_kappa_alphaT	( FEA_ShapeFunctionT&, FEA_ShapeFunctionT&, APS_MaterialT*, APS_VariableT&, APS_VariableT&, 
