// $Id: APS_V_kappa_alphaT.cpp,v 1.1 2004/03/02 23:46:50 raregue Exp $
#include "APS_V_kappa_alphaT.h"

using namespace Tahoe;

APS_V_kappa_alphaT::APS_V_kappa_alphaT	(FEA_ShapeFunctionT &Shapes_displ, FEA_ShapeFunctionT &Shapes_plast, APS_MaterialT *APS_Matl, 
						APS_VariableT &np1, 
...
/* destructor */
//APS_V_kappa_alphaT::~APS_V_kappa_alphaT(void) { }

//---------------------------------------------------------------------

void APS_V_kappa_alphaT::Initialize (int &in_ip, int &in_sd, int &in_en_displ, int &in_en_plast, int &in_state, int &in_str, 
...
void APS_V_kappa_alphaT::Construct (FEA_ShapeFunctionT &Shapes_displ, FEA_ShapeFunctionT &Shapes_plast, APS_MaterialT *APS_Matl, 
...
void APS_V_kappa_alphaT::Form_LHS_Keps_Kd ( dMatrixT &Keps, dMatrixT &Kd )
{
...
void APS_V_kappa_alphaT::Form_RHS_F_int ( dArrayT &F_int ) 
{
...
void APS_V_kappa_alphaT::Form_C_List (APS_MaterialT *APS_Matl)
{
...
void APS_V_kappa_alphaT::Form_V_S_Lists (  APS_VariableT &npt, APS_VariableT &n )
{
	...
	#pragma message("APS_V_kappa_alphaT::Form_V_S_Lists: are these grads what I think they are? ")
...
void APS_V_kappa_alphaT::Form_VB_List (void)
{					
...
void APS_V_kappa_alphaT::Form_B_List (void)
{
...
void APS_V_kappa_alphaT::Get ( StringT &Name, FEA_dMatrixT &tensor )
{
	if ( Name == "grad_u" )
		...
		cout << " ...ERROR: APS_V_kappa_alphaT::Get() >> Unknown tensor '"<<Name<<"' requested. \n";
}

//##############################################################################################

void APS_V_kappa_alphaT::Get ( StringT &Name, FEA_dVectorT &vector )
{
	if ( Name == "gammap" )
		vector = V[kgammap];
	else if ( Name == "out" )
		...
		cout << " ...ERROR: APS_V_kappa_alphaT::Get() >> Unknown vector '"<<Name<<"' requested. \n";
}

//##################################################################################

void APS_V_kappa_alphaT::Get ( StringT &Name, FEA_dScalarT &scalar )
{
	if ( Name == "kappa" )
		scalar = S[kIV_kappa1];
	else
		cout << " ...ERROR: APS_V_kappa_alphaT::Get() >> Unknown scalar '"<<Name<<"' requested. \n";
}
