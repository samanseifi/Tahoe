// $Id: APS_V_kappa_gpT.h,v 1.1 2004/03/02 23:46:50 raregue Exp $
#ifndef _APS_V_kappa_gp_T_H_ 
#define _APS_V_kappa_gp_T_H_ 

#include "V_PlastT.h"

namespace Tahoe {

/** APS_V_kappa_gpT: This class contains methods which build stiffness matricies 
 ...
 *  with same kappa for each slip system alpha;
 *  with vector basis functions for Plast field
 **/


class APS_V_kappa_gpT : public V_PlastT
{
	...
	//--------------------------------------------------------------
 	...
 	APS_V_kappa_gpT	( void ) { }
								
	APS_V_kappa_gpT	( FEA_ShapeFunctionT&, FEA_ShapeFunctionT&, APS_MaterialT*, APS_VariableT&, APS_VariableT&, 
	...
	protected:
		...
		APS_V_FEA_Data_Processor_PlastT Data_Pro_Plast; 
