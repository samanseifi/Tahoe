// $Id: APS_V_Bal_EqT.h,v 1.1 2004/03/02 23:46:48 raregue Exp $
#ifndef _APS_V_BAL_EQ_T_H_ 
#define _APS_V_BAL_EQ_T_H_ 

#include "V_BalLinMomT.h"

namespace Tahoe {

/** APS_V_Bal_EqT: This class contains methods which build stiffness matricies 
...
class APS_V_Bal_EqT	: public V_BalLinMomT
{
	...
	enum C_T { 
		...
		APS_V_Bal_EqT 	( int& nipsurf, int& nensurf, FEA_ShapeFunctionT &Shapes_displ, FEA_ShapeFunctionT &Shapes_plast, 
