...
int main(int argc, char *argv[])
{
  if(argc < 2) {
    cout << endl 
	 << "-- Plot Partial Particles from A Section--" << endl
	 << "Usage:" << endl
	 << "1) process a single file:  plotsec particle_file" << endl
	 << "   --example: plosec iso_particle_008" << endl
	 << "2) process multiple files: plotsec particle_file_prefix  first_suffix  last_suffix  suffix_increment" << endl
	 << "   --example: plotsec iso_particle  0  100  5" << endl << endl;
    return -1;
  }	
