/* $Id: EAMFCC3D_edge.h,v 1.1 2009/06/03 03:17:03 hspark Exp $ */
/* created: hspark (6/2/2009) */
#ifndef _EAMFCC3D_EDGE_H_
#define _EAMFCC3D_EDGE_H_
...
class EAMFCC3D_edge: public FCCLatticeT_Surf
{
public:
	...
	/** constructor */
	EAMFCC3D_edge(int nshells, int normal);

	/* destructor */
	virtual ~EAMFCC3D_edge(void);
