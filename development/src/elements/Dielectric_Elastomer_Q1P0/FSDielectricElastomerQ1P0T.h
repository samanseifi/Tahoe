...
#if !defined(_FSDielectricElastomerQ1P0T_)
#define _FSDielectricElastomerQ1P0T_
...
namespace Tahoe {
  ...
  class FSDEMatSupportQ1P0T;

  // interface for finite deformation dielectric elastomers 
  // based on 2008 JMPS paper of Suo et al.
  
  class FSDielectricElastomerQ1P0T: public FiniteStrainT {

  public:

    // constructor
    FSDielectricElastomerQ1P0T(const ElementSupportT& support);

    // destructor
    virtual ~FSDielectricElastomerQ1P0T();
  ...
  protected:
    ...
    // FSDielectricElastomerQ1P0T::NewMaterialList is called.
    FSDEMatSupportQ1P0T* fFSDEMatSupportQ1P0;
...
#endif // _FSDielectricElastomerQ1P0T_
