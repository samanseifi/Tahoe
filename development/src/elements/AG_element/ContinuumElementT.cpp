...
ParameterInterfaceT* ContinuumElementT::NewSub(const StringT& name) const
{
	...
	// as reference
	//ParameterListT& GeometryT::fQuadAG;
	//GeometryT::fQuadAG.SetName("quadAG_params");
...
void ContinuumElementT::TakeParameterList(const ParameterListT& list)
{
	...
	//cout << "Check TakeParameterList for ElementBaseT" << endl;
	/* inherited */
	ElementBaseT::TakeParameterList(list);
	//cout << "ElementBaseT works good" << endl;
