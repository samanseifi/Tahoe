...
class InelasticDuctile_RP2DT;

/** Cohesive surface elements with rigid constraints */
class NodalRigidCSEAnisoT: public CSEAnisoT, public DOFElementT
{
public:
...
protected:
	 ...
	 * -# restoring last converged solution following NodalRigidCSEAnisoT::ResetState,
	 *    after the solution for the current step has failed. 
	 * -# forwarding the current solution after NodalRigidCSEAnisoT::Reconfigure
	...
	InelasticDuctile_RP2DT* fCZRelation;
...
#endif /* _NODAL_RIGID_CSE_ANISO_T_H_ */
