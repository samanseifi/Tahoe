...
#if !defined(_FSDielectricElastomerViscoT_)
#define _FSDielectricElastomerViscoT_
...
namespace Tahoe {
  ...
  public:
    ...
    // constructor
    //
    FSDielectricElastomerViscoT(const ElementSupportT& support);

    //
    // destructor
    //
    virtual ~FSDielectricElastomerViscoT();
  ...
  protected:
    ...
    // FSDielectricElastomerViscoT::NewMaterialList is called.
    //
    FSDEMatSupportViscoT* fFSDEMatSupportVisco;

  private:

	LocalArrayT fLocScalarPotential;	// electric potential
    FSDEMatViscoT* fCurrMaterial;
...
#include "FSDielectricElastomerViscoT.i.h"
#endif // _FSDielectricElastomerViscoT_
